  ...
  return (
    ...
    <Main header={
      ...
      <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base/7 font-semibold text-foreground   my-4" >Personal Information</h2>
            ...
            <div className="  grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-full flex items-center justify-end gap-x-6">
                ...
                <button
                  type="submit"
                  className="rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-primary/100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Save
                </button>
              </div>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-foreground">Delete account</h2>
          <p className="mt-1 text-sm/6 text-muted-foreground">No longer want to use our service? You can delete your account here. This action is not reversible. All information related to this account will be deleted permanently.</p>
